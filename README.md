...
[![Hex.pm](https://img.shields.io/hexpm/v/protocol_buffers.svg)](https://hex.pm/packages/protocol_buffers)
[![Build Status](https://travis-ci.org/demilletech/protobuf-elixir.svg?branch=master)](https://travis-ci.org/demilletech/protobuf-elixir)
...
2. Generate **simple and explicit** code with the power of Macro. (see [test/support/test_msg.ex](https://github.com/demilletech/protobuf-elixir/blob/master/test/support/test_msg.ex))
...
The package can be installed by adding `protocol_buffers` to your list of dependencies in `mix.exs`:

```elixir
def deps do
  [
    {:protocol_buffers, "~> 0.5.3"},
...
```
$ mix escript.install hex protocol_buffers
```
...
Thank you to [tony612](https://github.com/tony612) for doing the legwork on this repo
