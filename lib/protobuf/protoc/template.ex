defmodule Protobuf.Protoc.Template do
  @msg_tmpl Path.expand("./templates/message.ex.eex", :code.priv_dir(:protocol_buffers))
  @enum_tmpl Path.expand("./templates/enum.ex.eex", :code.priv_dir(:protocol_buffers))
  @svc_tmpl Path.expand("./templates/service.ex.eex", :code.priv_dir(:protocol_buffers))
